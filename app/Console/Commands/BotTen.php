...
class BotTen extends Command
{
     ...
     * @var string
     */
    protected $description = 'run every 10 minutes bot';
    ...
    {
        $setting = Setting::where('repeat','=',10)->where('status','=',Setting::STATUS_ACTIVE)->get();
