...
class BotFive extends Command
{
     ...
     * @var string
     */
    protected $description = 'run every 5 minutes bot';
    ...
    {
        $setting = Setting::where('repeat','=',5)->where('status','=',Setting::STATUS_ACTIVE)->get();
