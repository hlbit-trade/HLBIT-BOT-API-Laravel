...
class BotFiveteen extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'bot:fiveteen';
     ...
     * @var string
     */
    protected $description = 'run every 15 minutes bot';
    ...
    {
        $setting = Setting::where('repeat','=',15)->where('status','=',Setting::STATUS_ACTIVE)->get();
