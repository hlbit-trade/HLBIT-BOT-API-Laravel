...
class BotSixty extends Command
{
    /**
     ...
     * @var string
     */
    protected $description = 'run every 60 minutes bot';
    ...
    {
        $setting = Setting::where('repeat','=',60)->where('status','=',Setting::STATUS_ACTIVE)->get();
